    ...
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800">Neue Kategorie erstellen</h1>
            <p className="text-sm text-slate-500 mt-0.5">Fügen Sie Ihrem System eine neue Kategorie hinzu</p>
          </div>
        </div>
      </div>
